 ...
 *      int avlTreeRemove
 *	(
 *	tAVLTree *pTree ,      //트리 구조에 대한 포인터
 *	TREE_NODE *pRemoveNode  //삭제할 노드에 대한 포인터
 *	)
 * 
 *  트리에서 노드를 삭제합니다. 이 함수는 재귀 작업을 수행할 수 있습니다. 
 *  주기적 자체 균형, 노드를 제거하여 모든 하위 트리의 불균형을 만듭니다.
 *  자기 균형
 * 
 * Returns         :  1:成功
 *                    0:失败
 ...
 *            F   H          .E.  H                     \                                  
 *                                                       H                  
 *    E-노드 삭제  ==> E보다 약간 큰 F 찾기 ==>  E 노드 삭제, 자체 균형                                                          
 *                    F 및 E 스왑 포인터                                               
 ********************************************************************/ 
